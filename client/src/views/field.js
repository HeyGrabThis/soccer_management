  ...
  return tabStatus === 1 ? (
    <div className='fieldList-container'>
      <div className='fieldList-Rtab'>
        ...
        <div className='fieldList-RtabPlayers'>
          <div className='fieldList-RtabPlayersPlus'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              width='22'
              height='22'
            ...
            >
              <path
                fill-rule='evenodd'
                clip-rule='evenodd'
                d='M8 8C8 5.79086 9.79086 4 12 4C13.8638 4 15.4299 5.27477 15.874 7H17.917C17.441 4.16229 14.973 2 12 2C8.68629 2 6 4.68629 6 8C6 9.91121 6.8936 11.6137 8.28579 12.7125C4.60205 14.187 2 17.7896 2 22H4C4 17.5817 7.58172 14 12 14C12.3387 14 12.6724 14.021 13 14.0619V11.874C12.6804 11.9562 12.3453 12 12 12C9.79086 12 8 10.2091 8 8ZM18.546 17.4H20.8815C21.5962 18.7771 22 20.3414 22 22H20C20 20.2878 19.4621 18.7012 18.546 17.4ZM17.6 15.4C17.3791 15.4 17.2 15.2209 17.2 15V13.2H15.4C15.1791 13.2 15 13.0209 15 12.8V11.6C15 11.379 15.1791 11.2 15.4 11.2H17.2V9.4C17.2 9.17909 17.3791 9 17.6 9H18.8C19.0209 9 19.2 9.17909 19.2 9.4V11.2H21C21.2209 11.2 21.4 11.379 21.4 11.6V12.8C21.4 13.0209 21.2209 13.2 21 13.2H19.2V15C19.2 15.2209 19.0209 15.4 18.8 15.4H17.6Z'
                fill='#fff'
              />
            </svg>
          </div>
      ...
      >
        {players.map((player) => {
          return <PlayerList key={player.num} player={player}></PlayerList>;
        })}
      </Reorder.Group>
    </div>
  ) : (
